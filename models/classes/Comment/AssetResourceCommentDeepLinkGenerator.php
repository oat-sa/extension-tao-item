...
/**
 * Deep link for asset comments → Media Manager structure / media_manager.
 *
 * Class URI literal matches {@see ResourceCommentType::classUri()} for asset
 * (avoids a hard dependency on taoMediaManager).
 */
final class AssetResourceCommentDeepLinkGenerator implements ResourceCommentDeepLinkGeneratorInterface
{
    ...
    {
        return ResourceCommentType::ASSET;
    }
