...
/**
 * Deep link for item comments → Items structure / manage_items.
 */
final class ItemResourceCommentDeepLinkGenerator implements ResourceCommentDeepLinkGeneratorInterface
{
    ...
    {
        return ResourceCommentType::ITEM;
    }

    public function build(string $resourceUri): string
    {
        return $this->deepLinkBuilder->build(TaoOntology::CLASS_URI_ITEM, $resourceUri);
    }
}
