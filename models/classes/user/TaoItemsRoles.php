...
interface TaoItemsRoles
{
    ...
    public const ITEMS_MANAGER = 'http://www.tao.lu/Ontologies/TAOItem.rdf#ItemsManagerRole';
    ...
    public const ITEM_MANAGER = 'http://www.tao.lu/Ontologies/TAOItem.rdf#ItemManagerRole';
