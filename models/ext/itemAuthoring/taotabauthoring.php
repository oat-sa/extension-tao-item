...
error_reporting(E_ALL);
	...
	function getXML($idinstance,$idproperty)
	{
		...
		$output.='<FORM enctype="multipart/form-data" action="http://'.$_SERVER["HTTP_HOST"].'/Generis/generis/GenerisWidgets/ItemModels/savexml.php" name=newressource method=post><input type=hidden name=MAX_FILE_SIZE value=2000000>';
