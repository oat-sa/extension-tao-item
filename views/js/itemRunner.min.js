...
if(pkgMain&&(moduleName=pkgMain),bundleId=getOwn(bundlesMap,moduleName))return context.nameToUrl(bundleId,ext,skipExt);if(req.jsExtRegExp.test(moduleName))url=moduleName+(ext||"");else{for(paths=config.paths,syms=moduleName.split("/"),i=syms.length;i>0;i-=1)if(parentModule=syms.slice(0,i).join("/"),parentPath=getOwn(paths,parentModule)){isArray(parentPath)&&(parentPath=parentPath[0]),syms.splice(0,i,parentPath);break}url=syms.join("/"),url+=ext||(/^data\:|\?/.test(url)||skipExt?"":".js"),url=("/"===url.charAt(0)||url.match(/^[\w\+\.\-]+:/)?"":config.baseUrl)+url}return config.urlArgs?url+((-1===url.indexOf("?")?"?":"&")+config.urlArgs):url},load:function(id,url){
...
return"interactive"===script.readyState?interactiveScript=script:void 0}),interactiveScript)}var req,s,head,baseElement,dataMain,src,interactiveScript,currentlyAddingScript,mainScript,subPath,version="2.1.14",commentRegExp=/(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm,cjsRequireRegExp=/[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g,jsSuffixRegExp=/\.js$/,currDirRegExp=/^\.\//,op=Object.prototype,ostring=op.toString,hasOwn=op.hasOwnProperty,ap=Array.prototype,apsp=ap.splice,isBrowser=!("undefined"==typeof window||"undefined"==typeof navigator||!window.document),isWebWorker=!isBrowser&&"undefined"!=typeof importScripts,readyRegExp=isBrowser&&"PLAYSTATION 3"===navigator.platform?/^complete$/:/^(complete|loaded)$/,defContextName="_",isOpera="undefined"!=typeof opera&&"[object Opera]"===opera.toString(),contexts={},cfg={},globalDefQueue=[],useInteractive=!1;
...
return(b+"").toUpperCase()},D=function(){e.addEventListener?(e.removeEventListener("DOMContentLoaded",D,!1),p.ready()):"complete"===e.readyState&&(e.detachEvent("onreadystatechange",D),p.ready())},E={};p.fn=p.prototype={constructor:p,init:function(a,c,d){var f,g,i;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,this.length=1,this;if("string"==typeof a){if(f="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&a.length>=3?[null,a,null]:u.exec(a),f&&(f[1]||!c)){if(f[1])return c=c instanceof p?c[0]:c,i=c&&c.nodeType?c.ownerDocument||c:e,a=p.parseHTML(f[1],i,!0),v.test(f[1])&&p.isPlainObject(c)&&this.attr.call(a,c,!0),p.merge(this,a);if(g=e.getElementById(f[2]),
g&&g.parentNode){if(g.id!==f[2])return d.find(a);this.length=1,this[0]=g}return this.context=e,this.selector=a,this}return!c||c.jquery?(c||d).find(a):this.constructor(c).find(a)}return p.isFunction(a)?d.ready(a):(a.selector!==b&&(this.selector=a.selector,this.context=a.context),p.makeArray(a,this))},selector:"",jquery:"1.8.0",length:0,size:function(){return this.length},toArray:function(){return k.call(this)},get:function(a){return null==a?this.toArray():0>a?this[this.length+a]:this[a]},pushStack:function(a,b,c){var d=p.merge(this.constructor(),a);return d.prevObject=this,d.context=this.context,"find"===b?d.selector=this.selector+(this.selector?" ":"")+c:b&&(d.selector=this.selector+"."+b+"("+c+")"),
d},each:function(a,b){return p.each(this,a,b)},ready:function(a){return p.ready.promise().done(a),this},eq:function(a){return a=+a,-1===a?this.slice(a):this.slice(a,a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},slice:function(){return this.pushStack(k.apply(this,arguments),"slice",k.call(arguments).join(","))},map:function(a){return this.pushStack(p.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:j,sort:[].sort,splice:[].splice},p.fn.init.prototype=p.fn,p.extend=p.fn.extend=function(){var a,c,d,e,f,g,h=arguments[0]||{},i=1,j=arguments.length,k=!1;for("boolean"==typeof h&&(k=h,
h=arguments[1]||{},i=2),"object"!=typeof h&&!p.isFunction(h)&&(h={}),j===i&&(h=this,--i);j>i;i++)if(null!=(a=arguments[i]))for(c in a)d=h[c],e=a[c],h!==e&&(k&&e&&(p.isPlainObject(e)||(f=p.isArray(e)))?(f?(f=!1,g=d&&p.isArray(d)?d:[]):g=d&&p.isPlainObject(d)?d:{},h[c]=p.extend(k,g,e)):e!==b&&(h[c]=e));return h},p.extend({noConflict:function(b){return a.$===p&&(a.$=i),b&&a.jQuery===p&&(a.jQuery=h),p},isReady:!1,readyWait:1,holdReady:function(a){a?p.readyWait++:p.ready(!0)},ready:function(a){if(a===!0?!--p.readyWait:!p.isReady){if(!e.body)return setTimeout(p.ready,1);p.isReady=!0,a!==!0&&--p.readyWait>0||(d.resolveWith(e,[p]),p.fn.trigger&&p(e).trigger("ready").off("ready"));
}},isFunction:function(a){return"function"===p.type(a)},isArray:Array.isArray||function(a){return"array"===p.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==a?String(a):E[m.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==p.type(a)||a.nodeType||p.isWindow(a))return!1;try{if(a.constructor&&!n.call(a,"constructor")&&!n.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(c){return!1}var d;for(d in a);return d===b||n.call(a,d)},isEmptyObject:function(a){var b;for(b in a)return!1;return!0},error:function(a){throw new Error(a)},parseHTML:function(a,b,c){
var d;return a&&"string"==typeof a?("boolean"==typeof b&&(c=b,b=0),b=b||e,(d=v.exec(a))?[b.createElement(d[1])]:(d=p.buildFragment([a],b,c?null:[]),p.merge([],(d.cacheable?p.clone(d.fragment):d.fragment).childNodes))):null},parseJSON:function(b){return b&&"string"==typeof b?(b=p.trim(b),a.JSON&&a.JSON.parse?a.JSON.parse(b):w.test(b.replace(y,"@").replace(z,"]").replace(x,""))?new Function("return "+b)():void p.error("Invalid JSON: "+b)):null},parseXML:function(c){var d,e;if(!c||"string"!=typeof c)return null;try{a.DOMParser?(e=new DOMParser,d=e.parseFromString(c,"text/xml")):(d=new ActiveXObject("Microsoft.XMLDOM"),d.async="false",d.loadXML(c))}catch(f){d=b}return(!d||!d.documentElement||d.getElementsByTagName("parsererror").length)&&p.error("Invalid XML: "+c),
...
define("lodash",[],function(){return ut})):nt&&tt?et?(tt.exports=ut)._=ut:nt._=ut:Z._=ut}.call(this),define("iframeNotifier",["jquery","lodash"],function($,_){function hasAccess(windowElt){return!(!window.__knownParent__||!windowElt||windowElt===window)}var xDomMessaging={parent:function(eventName,args){_.defer(function(){if(hasAccess(window.parent)&&window.parent.$){var _$=window.parent.$;_$(window.parent.document).trigger(eventName,args||[])}})},top:function(eventName,args){_.defer(function(){if(hasAccess(window.top)&&window.top.$){var _$=window.top.$;_$(window.top.document).trigger(eventName,args||[])}})}};return xDomMessaging}),define("jquery.sizechange",["jquery","lodash"],function($,_){
"use strict";function isDOM3EventSupported(){return window.MutationObserver||window.WebKitMutationObserver||!1}function isDOM2EventSupported(){var p=document.createElement("p"),flag=!1;if(p.addEventListener)p.addEventListener("DOMAttrModified",function(){flag=!0},!1);else{if(!p.attachEvent)return!1;p.attachEvent("onDOMAttrModified",function(){flag=!0})}return p.setAttribute("id","__dummy_domtest_target"),flag}$.fn.sizeChange=function(cb){var $this=this,running=!1;if(cb=cb||$.noop(),0===$this.length)return $this;var execCb=_.throttle(function(done){cb(),_.delay(done,1),done(),$this.find("img").one("load",function(){cb()})},10);if(isDOM3EventSupported()){var MutationObserver=window.MutationObserver||window.WebKitMutationObserver,mutationOptions={
childList:"IFRAME"!==this[0].nodeName,subtree:!0,attributes:!0,attributeFilter:["style","width","height"]},observer=new MutationObserver(function(mutations){for(var i in mutations)if(null!==mutations[i].addedNodes||null!==mutations[i].attributeName)return stop(),void execCb(start)}),start=function(){$this.each(function(){observer.observe(this,mutationOptions)})},stop=function(){observer.disconnect()};start()}else{if(!isDOM2EventSupported())throw new Error("Event listening not supported");var runs=function(){running=!1};$this.on("DOMAttrModified",function(event){"style"!==event.attrName||running||(running=!0,execCb(runs))}),$this.on("DOMNodeRemoved DOMNodeInserted DOMNodeInsertedIntoDocument DOMNodeRemovedFromDocument",function(event){
1!==event.target.nodeType||running||(running=!0,execCb(runs))})}return this}}),define("iframeResizer",["jquery","iframeNotifier","jquery.sizechange"],function($,iframeNotifier){"use strict";var Resizer={autoHeight:function($frame,restrict,plus){var self=this;return restrict=restrict||"body",plus=plus||0,$frame.on("load",function(){var $frameContent=$frame.contents(),height=$frameContent.height(),sizing=!1,resizePop=function(){sizing===!1&&(sizing=!0,setTimeout(function(){self._adaptHeight($frame,height,plus),sizing=!1},1))};self._adaptHeight($frame,height);try{var onSizeChange=function(){var newHeight=$frameContent.height();newHeight>height&&(height=newHeight,
resizePop()),newHeight>height&&(height=newHeight,resizePop())};$frameContent.find(restrict).sizeChange(onSizeChange),$frameContent.on("resize",onSizeChange)}catch(e){console.warning("Fallback to set interval"),setInterval(function(){var newHeight=$frameContent.height();newHeight>height&&(height=newHeight,resizePop())},10)}}),$frame},eventHeight:function($frame,diff){var self=this;$frame.on("load.eventHeight",function(){var newdiff=parseInt($frame.contents().height(),10)-parseInt($frame.height(),10);newdiff>diff&&(diff=newdiff),self._adaptHeight($frame,$frame.contents().height()+diff)}),$(document).on("heightchange",function(e,height,plus){plus=plus||0,self._adaptHeight($frame,height+plus+diff);
})},_notifyParent:function(height,plus){iframeNotifier.parent("heightchange",[height,plus||0])},_adaptHeight:function($frame,height,plus){$frame.height(height),this._notifyParent(height,plus)}};return Resizer}),define("urlParser",["lodash"],function(_){function UrlParser(url){this.url=url;var detachedAnchor=document.createElement("a");detachedAnchor.href=url,this.data=_.pick(detachedAnchor,urlParts),this.params=UrlParser.extractParams(this.data.search)}var urlParts=["hash","host","hostname","pathname","port","protocol","search"];return UrlParser.extractParams=function(search){var params={};return search.replace(/^\?/,"").replace(/([^=&]+)=([^&]*)/g,function(m,key,value){
params[decodeURIComponent(key)]=decodeURIComponent(value)}),params},UrlParser.prototype.get=function(what){return _.contains(urlParts,what)?this.data[what]:!1},UrlParser.prototype.getParams=function(search){return this.params},UrlParser.prototype.setParams=function(params){_.isObject(params)&&(this.params=params)},UrlParser.prototype.addParam=function(key,value){key&&(this.params[key]=value)},UrlParser.prototype.getPaths=function(){return this.data.pathname.replace(/^\/|\/$/g,"").split("/")},UrlParser.prototype.getUrl=function(exclude){var url="";return exclude=exclude||[],this.data&&(this.data.hostname&&!_.contains(exclude,"host")&&(url+=(this.data.protocol?this.data.protocol:"http:")+"//"+this.data.hostname.replace(/\/$/,""),
this.data.port&&80!==this.data.port&&"80"!==this.data.port&&"0"!==this.data.port&&(url+=":"+this.data.port)),/\/$/.test(url)||/^\//.test(this.data.pathname)||(url+="/"),url+=this.data.pathname,this.params&&!_.contains(exclude,"params")&&(url+="?",_.forEach(this.params,function(value,key){url+=encodeURIComponent(key)+"="+encodeURIComponent(value)+"&"}),url=url.substring(0,url.length-1)),this.data.hash&&!_.contains(exclude,"hash")&&(url+=this.data.hash)),url},UrlParser.prototype.getBaseUrl=function(){var baseUrl=this.getUrl(["params","hash"]),paths=this.getPaths(),lastPart=paths[paths.length-1];return paths.length>0&&/\.[a-z]+$/.test(lastPart)&&(baseUrl=baseUrl.replace(lastPart,"").replace(/\/\/$/,"/")),
baseUrl},UrlParser.prototype.checkCORS=function(parsedUrl){if(parsedUrl=parsedUrl||new UrlParser(window.location),parsedUrl instanceof UrlParser)return this.get("protocol")===parsedUrl.get("protocol")&&this.get("hostname")===parsedUrl.get("hostname")&&this.get("port")===parsedUrl.get("port");throw new Error("parsedUrl parameter must be an instanceof UrlParser")},UrlParser}),define("taoItems/controller/runtime/itemRunner",["jquery","lodash","iframeResizer","iframeNotifier","urlParser"],function($,_,iframeResizer,iframeNotifier,UrlParser){var itemRunner={start:function(options){var $frame=$('<iframe id="item-container" class="toolframe" frameborder="0" style="width:100%;height:100%;overflow:hidden" scrolling="no"></iframe>');
...
$frame.attr("src",itemUrl.getUrl())},_.defer(function(){iframeNotifier.parent("serviceready")})})}};return itemRunner}),function(window){"use strict";var appConfig=document.getElementById("amd-loader").getAttribute("data-config");require([appConfig],function(){require(["taoItems/controller/runtime/itemRunner"],function(itemRunner){itemRunner.start(window.itemRunnerOptions)})})}(window),define("taoItems/itemRunner",function(){});
//# sourceMappingURL=itemRunner.min.js.map