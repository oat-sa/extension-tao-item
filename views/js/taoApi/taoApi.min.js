...
const URI={'LABEL':'http://www.w3.org/2000/01/rdf-schema#label','ENDORSMENT':'##NAMESPACE#ENDORSMENT','SUBJECT':'http://www.tao.lu/Ontologies/TAOSubject.rdf#Subject','SUBJETC_LOGIN':'http://www.tao.lu/Ontologies/generis.rdf#login','SUBJETC_FIRSTNAME':'http://www.tao.lu/Ontologies/generis.rdf#userFirstName','SUBJETC_LASTNAME':'http://www.tao.lu/Ontologies/generis.rdf#userLastName','ITEM':'http://www.tao.lu/Ontologies/TAOItem.rdf#Item','PROCESS':'http://www.tao.lu/middleware/taoqual.rdf#i119010455660544','TEST':'http://www.tao.lu/Ontologies/TAOTest.rdf#Test','DELIVERY':'http://www.tao.lu/Ontologies/TAODelivery.rdf#Delivery'};const STATE={'ITEM':{'PRE_FINISHED':'pre_item_finished','FINISHED':'item_finished','POST_FINISHED':'post_item_finished'}};
...
if(typeof(finish)!='function'){var _stateContext=window;function finish(){$(_stateContext).trigger(STATE.ITEM.PRE_FINISHED);$(_stateContext).trigger(STATE.ITEM.FINISHED);$(_stateContext).trigger(STATE.ITEM.POST_FINISHED);}
function onFinish(callback){$(_stateContext).bind(STATE.ITEM.FINISHED,callback);}
function beforeFinish(callback){$(_stateContext).bind(STATE.ITEM.PRE_FINISHED,callback);}
function afterFinish(callback){$(_stateContext).bind(STATE.ITEM.POST_FINISHED,callback);}}
