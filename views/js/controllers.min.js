...
}),itemUri=_itemUri,overlay};return{init:init,show:show}}),define("taoItems/controller/items/action",["layout/actions/binder","uri","taoItems/preview/preview"],function(binder,uri,preview){binder.register("itemPreview",function(actionContext){preview.init(actionContext.id),preview.show()})}),define("taoItems/controller/items/edit",["module","layout/actions"],function(module,actions){var editItemController={start:function(){var config=module.config(),previewAction=(!!config.isPreviewEnabled,!!config.isAuthoringEnabled,actions.getBy("item-preview")),authoringAction=actions.getBy("item-authoring");previewAction&&(previewAction.state.disabled=!config.isPreviewEnabled),authoringAction&&(authoringAction.state.disabled=!config.isAuthoringEnabled),actions.updateState()
