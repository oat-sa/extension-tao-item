...
var $toolContainer=$(this);_.forEach(tools,function(tool,id){var $btn=$toolContainer.children('[data-control="'+id+'"]');$btn.length&&(tool.clear($btn),$btn.remove())})})}),{isValid:isValidConfig,initExtraButtons:initExtraButtons}}),define("taoItems/controller/preview/itemRunner",["module","jquery","lodash","serviceApi/ServiceApi","serviceApi/PseudoStorage","serviceApi/UserInfoService","taoItems/runtime/ItemServiceImpl","taoItems/preview/actionBarHook","urlParser"],function(module,$,_,ServiceApi,PseudoStorage,UserInfoService,ItemServiceImpl,actionBarHook,UrlParser){"use strict";var _initCustomButtons=function(){var config=module.config(),buttons=config.extraButtons||{},$container=$(".extra-button-action-bar");
