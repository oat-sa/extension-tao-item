define("taoItems/controller/routes",[],function(){"use strict";return{Items:{deps:"controller/items/action",css:"preview",actions:{editItem:"controller/items/edit"}},ItemPreview:{css:"preview",actions:{index:"controller/preview/itemRunner"}}}}),define("json!taoItems/preview/resources/device-list.json",function(){return{tablets:{"193986c3715c81838870f908fa98d69a":{label:"Amazon Kindle Fire HDX 7″",width:960,height:600},"4e8eafab11aad1486992d7ee2c8c16ca":{label:"Apple iPad",width:1024,height:768},"5aac2932d9ad00d6d8a1604b8f9e4e8d":{label:"Google Nexus 10, Motorola Xoom, Xyboard",width:1280,height:800},"9805d9753ad08c7630a9ee5418aa6c6c":{label:"Google Nexus 7",width:966,
height:604},d4a431cedf4705d6bf2cba6d5788378b:{label:"Samsung Galaxy Tab 7.7, 8.9, 10.1",width:1280,height:800}},phones:{"1b89338531ef0155c8d6abc2ac02c81a":{label:"Apple iPhone 3GS",width:320,height:480,scaleFactor:1,dpWidth:320,dpHeight:480},"3f89da99d84214cde7df87ebe0699a6f":{label:"Apple iPhone 4",width:640,height:960,scaleFactor:2,dpWidth:320,dpHeight:1920},"0d36971a5b98b367f54ced708c9af849":{label:"Apple iPhone 5",width:640,height:1136,scaleFactor:2,dpWidth:320,dpHeight:2272},"026beffcc051af995660ebdede986ace":{label:"BlackBerry Z10",width:768,height:1280,scaleFactor:2,dpWidth:384,dpHeight:2560},fd2dd53e667d6d49e4fa73356fa941dd:{label:"BlackBerry Z30",width:720,
height:1280,scaleFactor:2,dpWidth:360,dpHeight:2560},"707584c1ae17d9b5b2cbe8603c91c147":{label:"Google Nexus 4",width:768,height:1280,scaleFactor:2,dpWidth:384,dpHeight:2560},"91823264de952e7f2347e07db5c4058b":{label:"Google Nexus 5",width:1080,height:1920,scaleFactor:3,dpWidth:360,dpHeight:5760},cd69817a6e147e8a4677389e56fcf568:{label:"Google Nexus S",width:480,height:800,scaleFactor:1.5,dpWidth:320,dpHeight:1200},"75994faa6a38e31e99b53fcd75534a33":{label:"HTC Evo, Touch HD, Desire HD, Desire",width:480,height:800,scaleFactor:1.5,dpWidth:320,dpHeight:1200},"0cab4dfccdfc880687cb608cfe4159db":{label:"HTC One X, EVO LTE",width:720,height:1280,scaleFactor:2,dpWidth:360,
dpHeight:2560},c4ff41fcba24d74fc21dc3490ca1edc9:{label:"HTC Sensation, Evo 3D",width:540,height:960,scaleFactor:1.5,dpWidth:360,dpHeight:1440},fa969a5e0dd2de53700eeee4ba4ba142:{label:"LG Optimus 2X, Optimus 3D, Optimus Black",width:480,height:800,scaleFactor:1.5,dpWidth:320,dpHeight:1200},"33c4f9364e295ec03531f3a3425819cf":{label:"LG Optimus G",width:768,height:1280,scaleFactor:2,dpWidth:384,dpHeight:2560},bc47f5275f0efd56fee52d43a8082981:{label:"LG Optimus LTE, Optimus 4X HD",width:720,height:1280,scaleFactor:1.7,dpWidth:424,dpHeight:2176},"0732887e6e324fd10777b735520a34cf":{label:"LG Optimus One",width:320,height:480,scaleFactor:1.5,dpWidth:213,dpHeight:720
},"2e38a78364f09d0da0e9e1a3a68e7fb0":{label:"Motorola Defy, Droid, Droid X, Milestone",width:480,height:854,scaleFactor:1.5,dpWidth:320,dpHeight:1281},bd4b78dddc7c9625a4141a1b1ddabb87:{label:"Motorola Droid 3, Droid 4, Droid Razr, Atrix 4G, Atrix 2",width:540,height:960,scaleFactor:1,dpWidth:540,dpHeight:960},"3bf1edf21cfa81006183d2b02974c84e":{label:"Motorola Droid Razr HD",width:720,height:1280,scaleFactor:1,dpWidth:720,dpHeight:1280},ab5a352e0e016b97dac986f06c394f55:{label:"Nokia C5, C6, C7, N97, N8, X7",width:360,height:640,scaleFactor:1,dpWidth:360,dpHeight:640},"4826fb7d7257aeaac992ce699df41b3c":{label:"Nokia Lumia 7X0, Lumia 8XX, Lumia 900, N800, N810, N900",
...
hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'-preview-container preview-container">\n                        <div class="preview-item-container"></div>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n    <div id="preview-console">\n        <span class="icon-close preview-console-closer" title="'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Close console",options):helperMissing.call(depth0,"__","Close console",options)))+'"></span>\n        <div class="preview-console-header grid-row clearfix">\n            <div class="col-12">\n                <button type="button" class="btn-info small rgt" id="preview-submit-button">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,
options={hash:{},data:data},helper?helper.call(depth0,"Submit",options):helperMissing.call(depth0,"__","Submit",options)))+'</button>\n            </div>\n        </div>\n        <div class="preview-console-body clear">\n            <ul></ul>\n        </div>\n    </div>\n</div>'})}),define("taoItems/preview/preview",["jquery","lodash","i18n","util/strPad","json!taoItems/preview/resources/device-list.json","tpl!taoItems/preview/tpl/preview","ui/themes","ui/themeLoader","ui/modal","select2","jquery.cookie"],function($,_,__,strPad,deviceList,previewTpl,themeHandler,themeLoader){"use strict";function _setupScreenSize(){screenSize={width:$(".preview-overlay").innerWidth(),
height:$(".preview-overlay").innerHeight()}}var overlay,container,typeDependant,$feedbackBox,$console,previewContainerMaxWidth,itemUri,orientation="landscape",previewType="standard",previewTypes={desktop:__("Desktop preview"),mobile:__("Mobile preview"),standard:__("Actual size")},themeObj=themeHandler.get("items")||{},$doc=$(document),$window=$(window),$body=$(document.body),screenSize={width:$window.innerWidth(),height:$window.innerHeight()},sizeSettings={width:0,height:0},scaleFactor=1,_getDeviceSelectorData=function(type){var devices="mobile"===type?deviceList.tablets:deviceList.screens,options=[];return _.forEach(devices,function(value){options.push({value:value.label,
label:value.label,dataValue:[value.width,value.height].join(","),selected:previewType===value.label})}),options},_setupTypeDependantElements=function(){typeDependant=overlay.add(overlay.find(".preview-scale-container").find('[class*="'+previewType+'"]'))},_setPreviewType=function(newType){if(newType!==previewType){var re=new RegExp(previewType,"g");typeDependant.each(function(i,el){el.className=el.className.replace(re,newType)}),previewType=newType}},_setOrientation=function(newOrientation){if(newOrientation!==orientation){var re=new RegExp(orientation,"g"),previewFrame=$(".preview-outer-frame")[0];previewFrame.className=previewFrame.className.replace(re,newOrientation),
orientation=newOrientation}},_scale=function(){_computeScaleFactor();var $scaleContainer=$(".preview-scale-container"),_scaleFactor="standard"===previewType?1:scaleFactor,containerScaledWidth=$scaleContainer.width()*_scaleFactor,left=(screenSize.width-containerScaledWidth)/2;$scaleContainer.css({left:left,"-webkit-transform":"scale("+_scaleFactor+","+_scaleFactor+")","-ms-transform":"scale("+_scaleFactor+","+_scaleFactor+")",transform:"scale("+_scaleFactor+","+_scaleFactor+")","-webkit-transform-origin":"0 0","-ms-transform-origin":"0 0","transform-origin":"0 0"})},_positionPreview=function(){var topBarHeight=$(".preview-utility-bar").outerHeight();overlay[0].style.top=topBarHeight+"px",
...
})},ItemServiceImpl.prototype.onKill=function(callback){this.serviceApi.onKill(callback)},ItemServiceImpl.prototype.getVariable=function(identifier,callback){"function"==typeof callback&&callback(this.stateVariables[identifier]||null)},ItemServiceImpl.prototype.setVariable=function(identifier,value){this.stateVariables[identifier]=value,this.serviceApi.setState(JSON.stringify(this.stateVariables))},ItemServiceImpl}),define("taoItems/preview/preview-console",["jquery"],function($){function unserializeUrl(params){var data={},hashes=params.split("&");for(var i in hashes)if("string"==typeof hashes[i]){var hash=hashes[i].split("=");if(2==hash.length)if(/\[\]$/.test(hash[0])){
var key=hash[0].replace(/\[\]$/,"");"undefined"==typeof data[key]&&(data[key]=[]),data[key].push(hash[1])}else data[hash[0]]=hash[1]}return data}return{setup:function(){var timer=new Date,$previewConsole=$("#preview-console",window.top.document),$consoleCtrls=$(".console-control",$previewConsole),$consoleContent=$(".console-content",$previewConsole),$consoleContentList=$(".console-content > ul",$previewConsole);$previewConsole.bind("updateConsole",function(event,type,message){var hour=timer.getHours(),min=timer.getMinutes(),sec=timer.getSeconds(),logTime=(hour>10?hour:"0"+hour)+":"+(min>10?min:"0"+min)+":"+(sec>10?sec:"0"+sec);$consoleContentList.append("<li><b>["+logTime+"] "+type+"</b>: "+message+"</li>");
}),$(".ui-icon-circle-close",$consoleCtrls).on("click",function(event){event.preventDefault(),$previewConsole.hide()}),$(".ui-icon-trash",$consoleCtrls).on("click",function(event){event.preventDefault(),$consoleContentList.empty()}),$(".toggler",$consoleCtrls).on("click",function(event){event.preventDefault(),$consoleContent.toggle(),$(this).toggleClass("ui-icon-circle-minus").toggleClass("ui-icon-circle-plus")}),$("body").ajaxSuccess(function(event,request,settings){if(/LegacyPreviewApi/.test(settings.url)){var message="";if(/save$/.test(settings.url)){var data=unserializeUrl(decodeURIComponent(settings.data));for(var key in data)"token"!==key&&(message+="<br />"+key+" = "+data[key]);
""!==message&&(message+="<br />",$previewConsole.trigger("updateConsole",["push data",message]))}else if(/traceEvents$/.test(settings.url)){var data=unserializeUrl(decodeURIComponent(settings.data));if(data.events){for(var index in data.events)try{var eventData=$.parseJSON(data.events[index]);message+="<br />"+eventData.type+" on element "+eventData.name,"noID"!==eventData.id&&(message+="[id="+eventData.id+"]")}catch(exp){}message+="<br />",$previewConsole.trigger("updateConsole",["trace events",message])}}else if(/saveContext$/.test(settings.url)){var data=unserializeUrl(decodeURIComponent(settings.data));for(key in data)"token"!==key&&(message+="<br />"+key+" = "+data[key]);
message+="<br />",$previewConsole.trigger("updateConsole",["save context",message])}else if(/retrieveContext$/.test(settings.url)){var data=unserializeUrl(decodeURIComponent(settings.data));for(key in data)"token"!==key&&(message+="<br />"+key+" = "+data[key]);message+="<br />",$previewConsole.trigger("updateConsole",["retrieved context",message])}else if(/evaluate$/.test(settings.url)){var data=unserializeUrl(decodeURIComponent(settings.data));if(data.data){try{var matchingDataList=$.parseJSON(data.data);for(key in matchingDataList)message+="<br />"+matchingDataList[key].identifier+" = "+matchingDataList[key].value}catch(exp){}message+="<br />",$previewConsole.trigger("updateConsole",["sent answers",message]);
}}else message="<br />"+settings.type+" "+settings.url+" ? "+decodeURIComponent(settings.data)+" => "+request.responseText,$previewConsole.trigger("updateConsole",["remote request",message])}})}}}),define("taoItems/controller/preview/itemRunner",["module","jquery","lodash","serviceApi/ServiceApi","serviceApi/PseudoStorage","serviceApi/UserInfoService","taoItems/runtime/ItemServiceImpl","taoItems/preview/preview-console","urlParser","iframeResizer"],function(module,$,_,ServiceApi,PseudoStorage,UserInfoService,ItemServiceImpl,previewConsole,UrlParser,iframeResizer){var previewItemRunner={start:function(options){var conf=_.merge(module.config(),options||{});if(conf.previewUrl){
previewConsole.setup();var resultServer=_.defaults(conf.resultServer,{module:"taoResultServer/ResultServerApi",endpoint:"",params:{}});require([resultServer.module],function(ResultServerApi){var resultServerApi=new ResultServerApi(resultServer.endpoint,resultServer.params),serviceApi=new ServiceApi(conf.previewUrl,{},"preview",new PseudoStorage,new UserInfoService(conf.userInfoServiceRequestUrl,{})),itemApi=new ItemServiceImpl({serviceApi:serviceApi,resultApi:resultServerApi}),callUrl=new UrlParser(serviceApi.getCallUrl()),isCORSAllowed=callUrl.checkCORS();callUrl.addParam("clientConfigUrl",conf.clientConfigUrl);var $frame=$('<iframe id="preview-container" name="preview-container" src="'+callUrl.getUrl()+'"></iframe>');
iframeResizer.autoHeight($frame,"body",10),$frame.on("load",function(){var frame=this;itemApi.connect(frame),isCORSAllowed===!0&&(frame.contentWindow.__knownParent__=!0),$(document).on("itemready",function(){itemApi.connect(frame)})}),$(".preview-item-container").append($frame),$("#finishButton").click(function(){itemApi.finish()})})}}};return previewItemRunner}),define("taoItems/controller/runtime/itemRunner",["jquery","lodash","iframeResizer","iframeNotifier","urlParser"],function($,_,iframeResizer,iframeNotifier,UrlParser){var itemRunner={start:function(options){var $frame=$('<iframe id="item-container" class="toolframe" frameborder="0" style="width:100%;height:100%;overflow:hidden" scrolling="no"></iframe>');
...
})),itemUrl=new UrlParser(itemPath),isCORSAllowed=itemUrl.checkCORS();itemUrl.addParam("clientConfigUrl",clientConfigUrl),itemUrl.addParam("timeout",timeout),iframeResizer.autoHeight($frame,"body",10),$(document).on("itemloaded",function(){iframeNotifier.parent("serviceloaded")}).on("responsechange",function(e,responseId,response){iframeNotifier.parent("responsechange",[responseId,response])}).on("stateready",function(e,elmentId,state){iframeNotifier.parent("stateready",[elmentId,state])}).on("itemready",function(){itemApi.connect($frame[0])}),$frame.on("load",function(){itemApi.connect($frame[0]),isCORSAllowed===!0&&(this.contentWindow.__knownParent__=!0)}),
$frame.attr("src",itemUrl.getUrl())},_.defer(function(){iframeNotifier.parent("serviceready")})})}};return itemRunner});
