...
console.log('buggy');return result;};this.slider=function(){return{"identifier":_this.opts['responseIdentifier'],"value":parseInt($("#"+_this.id+'_qti_slider_value').val())};};this.upload=function(){var value=0;switch(_this.opts['baseType']){case"float":value=parseFloat($("#"+_this.id+'_data').val());break;case"integer":default:value=parseInt($("#"+_this.id+'_data').val());}
