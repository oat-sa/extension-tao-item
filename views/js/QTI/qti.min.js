...
myQTIWidget[typeName].apply();$("#qti_validate").bind("click",function(){var result=myResultCollector[typeName].apply();matching_setResponses([result]);matching_evaluate();});}