...
if(typeof(value)=='object'){if(value.value){$(qti_item_id+" ul li#"+value.value).addClass("tabActive");}}}}}};this.inline_choice=function(){if(_this.opts["values"]){var value=_this.opts["values"];if(typeof(value)=='string'&&value!=''){console.log($(qti_item_id+" option[value='"+value+"']"));$(qti_item_id+" option[value='"+value+"']").attr('selected',true);}}};this.order=function(){var sortableOptions={revert:true,axis:'y',containment:qti_item_id,placeholder:'sort-placeholder',tolerance:'pointer'};$(qti_item_id+" ul li").addClass('sort-vertical');if(_this.opts['orientation']){if(_this.opts['orientation']=='horizontal'){sortableOptions.axis='x';sortableOptions.placeholder='sort-placeholder-inline';sortableOptions['forcePlaceHolderWidth']=true;$(qti_item_id+" ul li").removeClass('sort-vertical').addClass('sort-horizontal').css('display','inline');}}
